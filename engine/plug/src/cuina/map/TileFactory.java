...
public class TileFactory
{
	...
	public static AutotileSet createAutotileSet(Resource resource, int tileSize) throws LoadingException
	{
		...
		{
			throw new LoadingException(resource.getFileName(), e);
		}
		...
		{
			throw new LoadingException("invalid autotile-format.");
		}
